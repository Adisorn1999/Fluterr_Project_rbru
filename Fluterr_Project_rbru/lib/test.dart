        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(10 * fem, 8 * fem, 131 * fem, 8 * fem),
              width: double.infinity,
              height: 66 * fem,
              decoration: BoxDecoration(
                color: Color(0xffffffff),
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(
                        6.25 * fem, 3.13 * fem, 5.47 * fem, 2.34 * fem),
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(5 * fem, 71 * fem, 5 * fem, 68 * fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
